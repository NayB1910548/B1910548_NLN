        ...
        <div class="donhang">
            <table class="table-header">
                <tr>
                    ...
                    <th title="Sắp xếp" style="width: 5%" onclick="sortDonHangTable('madon')">Mã đơn <i class="fa fa-sort"></i></th>
                    <th title="Sắp xếp" style="width: 5%" onclick="sortDonHangTable('khach')">Khách hàng <i class="fa fa-sort"></i></th>
                    <th title="Sắp xếp" style="width: 15%" onclick="sortDonHangTable('ngaylap')">Ngày lập HD <i class="fa fa-sort"></i></th>
                    <th title="Sắp xếp" style="width: 10%" onclick="sortDonHangTable('SDT')">SDT <i class="fa fa-sort"></i></th>
                    <th title="Sắp xếp" style="width: 20%" onclick="sortDonHangTable('diachi')">Địa chỉ<i class="fa fa-sort"></i></th>
                    <th title="Sắp xếp" style="width: 20%" onclick="sortDonHangTable('PTTT')">Thanh toán <i class="fa fa-sort"></i></th>
                    <th title="Sắp xếp" style="width: 15%" onclick="sortDonHangTable('tongtien')">Tổng tiền <i class="fa fa-sort"></i></th>
                    <th title="Sắp xếp" style="width: 5%" onclick="sortDonHangTable('trangthai')">Trạng thái <i class="fa fa-sort"></i></th>
                </tr>
            </table>
            ...
            <?php
                ...
                foreach ($hd->select_all() as $rowname => $row) {
                    ...
                    <td  style='width: 10%'>" . $row['SDT'] . "</td>
                    <td  style='width: 20%'>" . $row['DiaChi'] . "</td>
                    <td  style='width: 20%'>" . $row['PhuongThucTT'] . "</td>
                    <td  style='width: 15%'>" . $row['TongTien'] . "</td>
                    <td  style='width: 5%'>" . $row['TrangThai'] . "</td>
                    </tr>";
                }
                echo "</table>";
            ?>
        ...
        <div class="khachhang">
            <table class="table-header">
                <tr>
                    ...
                    <th title="Sắp xếp"  onclick="sortKhachHangTable('MaND')">Mã KH <i class="fa fa-sort"></i></th>
